...
struct HomeBackupFeedRenderViewType {
...
class HomeViewControllerBackup: UIViewController {
    
    private var feedRenderModels = [HomeBackupFeedRenderViewType]()
    ...
    private func createMockModels() {
        ...
        for _ in 0..<5 {
            let viewModel = HomeBackupFeedRenderViewType(
...
extension HomeViewControllerBackup: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        let x = section
        var model: HomeBackupFeedRenderViewType
        if x == 0 {
...
extension HomeViewControllerBackup: ZLFeedPostHeaderTableViewCellDelegate {
...
extension HomeViewControllerBackup: ZLFeedPostActionsTableViewCellDelegate {
